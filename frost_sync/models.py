...
class Station(Base):
    ...
    provider: Mapped[str] = mapped_column(String(32), nullable=False, default="frost", index=True)
    provider_context: Mapped[Optional[str]] = mapped_column(String(2048))
...
class StationLatest(Base):
    ...
    precipitation_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    ...
    precipitation_3h: Mapped[Optional[float]] = mapped_column(Float)
    precipitation_3h_unit: Mapped[Optional[str]] = mapped_column(String(64))
    precipitation_3h_max: Mapped[Optional[float]] = mapped_column(Float)
    precipitation_3h_max_unit: Mapped[Optional[str]] = mapped_column(String(64))
    precipitation_3h_max_period: Mapped[Optional[str]] = mapped_column(String(128))
    ...
    snow_depth_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    snow_depth_change: Mapped[Optional[float]] = mapped_column(Float)
    snow_depth_change_unit: Mapped[Optional[str]] = mapped_column(String(64))
    ...
    wind_from_direction_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    wind_speed: Mapped[Optional[float]] = mapped_column(Float)
    wind_speed_unit: Mapped[Optional[str]] = mapped_column(String(64))
    wind_speed_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    wind_speed_max: Mapped[Optional[float]] = mapped_column(Float)
    wind_speed_max_unit: Mapped[Optional[str]] = mapped_column(String(64))
    ...
    discharge_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    ...
    groundwater_level_observed_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
